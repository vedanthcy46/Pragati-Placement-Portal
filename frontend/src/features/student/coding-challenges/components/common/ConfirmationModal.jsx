...
const ConfirmationModal = ({
  ...
  const confirmClasses =
    variant === 'danger'
      ...
      : 'bg-gradient-to-r from-orange-500 to-orange-600 shadow-orange-500/30 hover:shadow-orange-500/50';
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-[#0f0f0f] border border-gray-800 rounded-2xl shadow-2xl w-full max-w-md p-6 animate-fade-in">
        ...
        <h2 id="modal-title" className="text-lg font-bold text-gray-100 mb-2">
          {title}
        </h2>
